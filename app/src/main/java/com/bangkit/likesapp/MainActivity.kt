...
import com.bangkit.likesapp.databinding.ActivityMainBinding

class MainActivity : AppCompatActivity() {

    private lateinit var binding: ActivityMainBinding

    // Buatkan canvas dengan bitmap, lalu hubungkan dengan ImageView yang ada
    ...
    private val message = "Apakah kamu suka belajar?"
